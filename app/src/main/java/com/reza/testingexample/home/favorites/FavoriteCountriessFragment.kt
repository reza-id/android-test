...
class FavoriteCountriesFragment : Fragment(), AnkoComponent<Context> {
    private var favorites: MutableList<FavoriteCountry> = mutableListOf()
    private lateinit var adapter: FavoriteCountriesAdapter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = FavoriteCountriesAdapter(favorites) {
